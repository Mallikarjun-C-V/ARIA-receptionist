      ...
      <div style={{
        ...
        <div style={{ pointerEvents: 'auto', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16 }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <button onClick={onClear} style={{ background: 'rgba(10,10,20,0.7)', border: '1px solid rgba(0, 255, 0, 0.35)', color: 'var(--c-muted)', borderRadius: 8, padding: '5px 12px', cursor: 'pointer', fontSize: 10, fontFamily: 'inherit', letterSpacing: 0.5, backdropFilter: 'blur(8px)' }}>↺ Clear</button>
            <button onClick={onClose} style={{ background: 'rgba(10,10,20,0.7)', border: '1px solid rgba(255, 0, 0, 0.35)', color: 'var(--c-muted)', borderRadius: 8, padding: '5px 12px', cursor: 'pointer', fontSize: 10, fontFamily: 'inherit', letterSpacing: 0.5, backdropFilter: 'blur(8px)' }}>✕ Close</button>
          </div>
